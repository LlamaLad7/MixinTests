...
fun Project.fabricMixinJar(version: String): File = getJar("net.fabricmc:sponge-mixin:$version") {
    applyMixinPatches()
}
...
private fun Project.getJar(dependency: Any, routine: Configuration.() -> Unit = {}): File {
