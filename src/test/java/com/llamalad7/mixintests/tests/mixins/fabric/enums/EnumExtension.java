...
import com.llamalad7.mixintests.tests.targets.EnumTarget;
...
@MixinTest(box = EnumTarget.class, fabricMixin = TestOption.ON, minFabricMixin = "0.17.1")
public class EnumExtension {
    @Mixin(EnumTarget.NormalEnum.class)
    enum NormalMixin {
    ...
    @Mixin(EnumTarget.AbstractEnum.class)
    enum AbstractMixin {
